	...
	var intializeTransaction = function() {
		...
		return SuppliesApiService.getSupplyCosts()
			.then(function(response) {
		  		healthySnackCost = response.data.healthySnack;
			  	treatCost = response.data.treat;
			  	mediumLemonadeCost = response.data.mediumLemonade;
			  	largeLemonadeCost = response.data.largeLemonade;
