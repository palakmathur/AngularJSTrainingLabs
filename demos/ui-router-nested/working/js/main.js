...
app.config(['$stateProvider', '$urlRouterProvider', function($stateProvider, $urlRouterProvider) {
 ...
 app.controller('ShowsDetailController', ['$scope','$stateParams', function($scope, $stateParams) {
	 	$scope.selectedShow = _.find($scope.shows, function(show){return show.id == $stateParams.id});
